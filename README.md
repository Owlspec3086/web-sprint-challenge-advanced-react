...
Answer: Create a class, then add a empty method called render(), move the body of the render function, replace props with this.props in the render body, and delete the remaining empty function declaration. 

2. Describe the different phases of the component lifecycle.
Answer: Mounting this puts the elements into the DOM, updating which is whenever there is a change in the component's state or props. Unmounting removes a component from the DOM.

3. Demonstrate an understanding of class component lifecycle methods.
Answer: Called at the very beggining of a components life componentdidmount. It signals that the component have rendered properly. This makes it available in the DOM and is the best place to make API calls. Really bring the component to life. Using render which makes everything display properly on a users screen. You can impliment JSX in a render and also call any components and props in the order you would like them to appear on a users screen. Using unmounting is the last function that will be called in a components lifecycle, however; it is used to perform clean up for any DOM elements or timers created during the componentWillMount.

4. Define stateful logic.
Answer: Any code that uses state, but in the case of hooks I would define it as a behaviour created with the use of one or more hooks.

5. Describe how to test a React component with React Testing Library.
Answer: You can run your tests and see if they are successful rather than going through manually. Testing helps with knowing whether the app can be successfully downloaded, executed and interacted with the back-end. Helps to know that you app is functional.
